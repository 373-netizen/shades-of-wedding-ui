...
// Debugging message
echo "✅ Order ID Received in receipt.php: " . $order_id;
...
if (mysqli_num_rows($order_items) == 0) {
    die("❌ No order items found for Order ID: " . $order_id);
}

echo "<br>✅ Everything looks good! Proceeding to display receipt.";
?>
